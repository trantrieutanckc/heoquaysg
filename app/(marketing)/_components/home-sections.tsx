        ...
        <FadeUp className="flex flex-col items-center text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <a
              ...
              className="inline-flex items-center justify-center gap-2.5 bg-white text-primary hover:bg-orange-50 px-10 py-4 text-sm font-bold uppercase tracking-wider transition-colors shadow-xl"
            >
