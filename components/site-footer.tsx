        ...
        <div className="grid gap-10 sm:grid-cols-2 md:grid-cols-4">
          ...
          <div className="flex flex-col space-y-5 sm:col-span-2 md:col-span-2">
            ...
            {hasSocial && (
              <div className="flex items-center gap-4">
                {contactZalo && (
                  <a href={`https://zalo.me/${contactZalo.replace(/\s/g, "")}`} target="_blank" rel="noopener noreferrer" title="Zalo" className="h-9 w-9 flex items-center justify-center rounded-full bg-stone-800 text-stone-400 hover:bg-blue-500 hover:text-white transition-colors">
