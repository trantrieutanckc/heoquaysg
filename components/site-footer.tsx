    ...
    <footer className={cn("bg-stone-900 text-stone-300", className)}>
      ...
      <div className="container py-12 md:py-16">
        <div className="grid gap-10 sm:grid-cols-2 md:grid-cols-4">
          ...
          {/* Brand */}
          <div className="space-y-5 sm:col-span-2 md:col-span-2">
            <div className="flex items-center gap-3">
              {logoUrl ? (
                <img src={logoUrl} alt={name} className="h-11 w-11 object-cover" />
              ) : (
                <div className="h-11 w-11 bg-primary/20 flex items-center justify-center text-primary font-bold text-lg select-none border border-primary/30">
                  {name[0]}
                </div>
              )}
              <div>
            ...
            {hasSocial && (
              <div className="flex items-center gap-3 text-stone-500">
                {contactZalo && (
                  <a href={`https://zalo.me/${contactZalo.replace(/\s/g, "")}`} target="_blank" rel="noopener noreferrer" title="Zalo" className="hover:text-blue-400 transition-colors">
                ...
                {socialFacebook && (
                  <a href={socialFacebook} target="_blank" rel="noopener noreferrer" title="Facebook" className="hover:text-blue-400 transition-colors">
                    <svg viewBox="0 0 24 24" className="h-5 w-5" fill="currentColor" aria-hidden>
                ...
                {socialInstagram && (
                  <a href={socialInstagram} target="_blank" rel="noopener noreferrer" title="Instagram" className="hover:text-pink-400 transition-colors">
                    <svg viewBox="0 0 24 24" className="h-5 w-5" fill="currentColor" aria-hidden>
                ...
                {socialYoutube && (
                  <a href={socialYoutube} target="_blank" rel="noopener noreferrer" title="YouTube" className="hover:text-red-400 transition-colors">
                    <svg viewBox="0 0 24 24" className="h-5 w-5" fill="currentColor" aria-hidden>
