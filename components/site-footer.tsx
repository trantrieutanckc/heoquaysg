        ...
        <div className="grid gap-10 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-6">
          ...
          <div className="space-y-4 lg:col-span-2">
            ...
            <ul className="space-y-3">
              {contactAddress && (
                <li>
                  <a href={`https://maps.google.com/?q=${encodeURIComponent(contactAddress)}`} target="_blank" rel="noopener noreferrer" className="flex items-start gap-2 text-sm text-stone-400 hover:text-stone-100 transition-colors">
                  ...
                  <div className="flex items-center gap-3">
                    {contactPhone && (
                      <div className="relative inline-flex">
                        ...
                        <a href={`tel:${contactPhone.replace(/\s/g, "")}`} className="relative flex items-center gap-1.5 px-3 py-1 rounded-full bg-green-500 text-white hover:bg-green-600 transition-colors text-xs font-bold tracking-wide">
                    ...
                    {contactZalo && (
                      <div className="relative inline-flex">
                        ...
                        <a href={`https://zalo.me/${contactZalo.replace(/\s/g, "")}`} target="_blank" rel="noopener noreferrer" className="relative flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#0068FF] text-white hover:bg-[#0050CC] transition-colors text-xs font-bold tracking-wide">
