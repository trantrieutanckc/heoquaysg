              ...
              <div className="flex items-center gap-4">
                {contactPhone && (
                  <div className="relative inline-flex">
                    ...
                    <a href={`tel:${contactPhone.replace(/\s/g, "")}`} className="relative h-9 flex items-center gap-1.5 px-3 rounded-full bg-green-500 text-white hover:bg-green-600 transition-colors text-xs font-bold tracking-wide">
